...
//
// Caveat: the f function will be called on eash request so you are better to put
// any initialization sequesnce outside of this function.
...
// the chain and returns HandlerC instance.
